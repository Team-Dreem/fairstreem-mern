...
// const errorMsg = (
//   <React.Fragment>
//     <p>fill out all inputs please</p>
//   </React.Fragment>
// );
...
export default function AddSongModal() {
  ...
  const handleFormSubmit = async (event) => {
    ...
    if (
      ...
      post(url, formData, config).then(async (response) => {
          ...
          <div className={classes.paper}>
            ...
            <form onSubmit={handleFormSubmit}>
              ...
              <div>
                ...
                <br />
                <input name="album" id="album" onChange={handleChange} />
              </div>
              ...
              <div>
                ...
                >
                  ...
                  <option value={"600dfabaebcba48440047d26"}>
                    Rock/Alternative
                  </option>
            ...
            {errorMsgOpen ? <p>Please fill out all inputs</p> : null}
          </div>
        </Fade>
      </Modal>
